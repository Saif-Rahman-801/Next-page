...
import reader from "../Reader/reader.json";
...
const Home = () => {
  ...
  return (
    <div className="my-container flex flex-col items-center justify-center lg:flex-row ">
      {/* Text Content */}
      <div className="mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0">
        <div className="max-w-xl mb-6 lg:mt-8">
          <div>
            <p className="badge font-medium">On Sale!</p>
          </div>
